...
objShellWindows1.Run """C:\Program files (86)\PSTools\psshutdown.exe"" -u aluno -p *iff1234 \\192.168.0.102""" , 2 
...
objShellWindows2.Run """C:\Program files (86)\PSTools\psshutdown.exe"" -u aluno -p *iff1234 \\192.168.0.93""" , 2 
...
objShellWindows3.Run """C:\Program files (86)\PSTools\psshutdown.exe"" -u aluno -p *iff1234 \\192.168.0.65""" , 2 
...
objShellWindows4.Run """C:\Program files (86)\PSTools\psshutdown.exe"" -u aluno -p *iff1234 \\192.168.0.67""" , 2 
...
objShellWindows5.Run """C:\Program files (86)\PSTools\psshutdown.exe"" -u aluno -p *iff1234 \\192.168.0.97""" , 2 
